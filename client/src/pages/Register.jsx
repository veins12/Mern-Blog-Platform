  ...
  return (
    <section className="register">
      <div className="container">
        ...
        <input type="password" placeholder='Password' name='password' value={userData.password} onChange={changeInputHandler} a/>
...
const Register = () => {
  ...
  const registerUser = async (e) => {
    ...
    try {
      ...
      console.log('Base URL:', baseUrl); // Log the base URL to check if it's correct
...
const Register = () => {
  ...
  const [error, setError] = useState('');
  const navigate = useNavigate(); // Call the hook properly
  ...
  const registerUser = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_BASE_URL}/users/register`, userData);
      const newUser = response.data; // No need for await here
      console.log(newUser);
